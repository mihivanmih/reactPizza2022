...
const Cart = () => {
    ...
    const {totalPrice, items, allItems} = useSelector(selectorCart)
            ...
            <div className="container container--cart">
                <div className="cart">
                    ...
                    <div className="content__items">
                        { items.map(item =>
                            <CartItem key={ `id${ item.id }type${ item.type }size${ item.size }` } item={ item }/>
                        ) }
                    </div>
                    <div className="cart__bottom">
                        <div className="cart__bottom-details">
                            <span> Всего пицц: <b>{ allItems } шт.</b> </span>
